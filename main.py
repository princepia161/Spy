...
owner_id = [5938871512]
auth_users = [5938871512]
photo1 = 'https://envs.sh/PQ_.jpg'
getstatusoutput(f"wget {photo1} -O 'photo.jpg'")
photo = "photo.jpg"


token_cp = 'eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..7eMEWoboTE1iU6AjwoG61I5BfwWVgeyTyWhFt67Q6UrwihcUhETZ47-p5HUcvDB8'
    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            if "visionias" in url:
                ...
                bcov = 'bcov_auth=your_token' #yourcwtoken
